      ...
      <div className='rounded-md p-6 pt-3 border border-border dark:border-dark_border mt-6'>
        <div className='flex items-center gap-4'>
          <h5 className='text-base font-medium mt-3 mb-1'>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis architecto at obcaecati pariatur asperiores, voluptatibus sunt laborum. Beatae eveniet consectetur, quas nulla, voluptates deserunt illum laudantium, esse corrupti sed inventore.          </h5>
        </div>
